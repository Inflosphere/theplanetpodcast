...
!(function (t, e) {
              ...
              Object.keys(c).forEach(function (i) {
                !(function (t, e, i, n) {
                  ...
                  Object.keys(o).forEach(function (s) {
                    if (s.includes(n)) {
                      var r = o[s];
                      $(t, e, i, r.originalHandler, r.delegationSelector);
                    }
                  });
                })(t, c, i, e.slice(1));
              });
  ...
  j.on(
    ...
    _(function () {
      ...
      if (t) {
        var e = t.fn[W];
        (t.fn[W] = H.jQueryInterface),
          (t.fn[W].Constructor = H),
          (t.fn[W].noConflict = function () {
            return (t.fn[W] = e), H.jQueryInterface;
          });
      }
    });
  var R = (function (t) {
  ...
  j.on(
    ...
    _(function () {
      ...
      if (t) {
        var e = t.fn.button;
        (t.fn.button = R.jQueryInterface),
          (t.fn.button.Constructor = R),
          (t.fn.button.noConflict = function () {
            return (t.fn.button = e), R.jQueryInterface;
          });
      }
    });
  var q = {
      ...
      getDataAttribute: function (t, e) {
        return B(t.getAttribute("data-bs-" + F(e)));
      },
      offset: function (t) {
  ...
  j.on(
    ...
    j.on(window, "load.bs.carousel.data-api", function () {
      for (
        ...
        K.carouselInterface(t[e], C(t[e], "bs.carousel"));
    }),
    _(function () {
      var t = y();
      if (t) {
        var e = t.fn[Y];
        (t.fn[Y] = K.jQueryInterface),
          (t.fn[Y].Constructor = K),
        ...
        (s.show = function () {
          ...
          if (
            ...
            if (e) {
              ...
              if ((i = s ? C(s, "bs.collapse") : null) && i._isTransitioning)
                return;
            }
            if (
  ...
  function Lt(t) {
    ...
    if (l) {
      ...
      v === dt(i) && (v = _t(i)),
        ...
        o === ot &&
          ((f = nt), (d -= v.clientWidth - n.width), (d *= a ? 1 : -1));
    }
    var y,
  ...
  function Wt(t) {
    return jt(_t(t)).left + Nt(t).scrollLeft;
  }
  function Ht(t) {
    var e = vt(t),
      i = e.overflow,
  ...
  function Rt(t, e) {
    ...
    var i = (function t(e) {
      ...
      n = "body" === ct(i),
      o = dt(i),
      s = n ? [o].concat(o.visualViewport || [], Ht(i) ? i : []) : i,
      r = e.concat(s);
    return n ? r : r.concat(Rt(bt(s)));
  }
  function Bt(t) {
    return Object.assign(
      Object.assign({}, t),
  ...
  function Yt(t, e) {
    ...
    var i = e,
      ...
      C = Bt(Object.assign(Object.assign({}, y), k)),
      T = "popper" === d ? C : w,
      S = {
        top: b.top - T.top + m.top,
        bottom: T.bottom - b.bottom + m.bottom,
        left: b.left - T.left + m.left,
        right: T.right - b.right + m.right,
      },
        ...
        if (k) {
          if (s) {
            var x = "y" === b ? et : ot,
              ...
              H = N[O],
              R = Tt(0, C[L], j[L]),
              B = _ ? C[L] / 2 - M - R - W - S : P - R - W - S,
              F = _ ? -C[L] / 2 + M + R + H + S : z + R + H + S,
              q = e.elements.arrow && kt(e.elements.arrow),
              U = q ? ("y" === b ? q.clientTop || 0 : q.clientLeft || 0) : 0,
              Y = e.modifiersData.offset
                ? e.modifiersData.offset[e.placement][b]
                : 0,
              V = k[b] + B - Y - U,
              Q = k[b] + F - Y,
              X = Tt(p ? Math.min(A, V) : A, I, p ? Math.max(D, Q) : D);
            (k[b] = X), (E[b] = X - I);
          }
          if (a) {
            var K = "x" === b ? et : ot,
        ...
        (("body" !== ct(e) || Ht(s)) &&
          (l =
            (n = e) !== dt(n) && ht(n)
              ...
              : Nt(n)),
        ht(e)
          ? (((c = jt(e)).x += e.clientLeft), (c.y += e.clientTop))
          : s && (c.x = Wt(s))),
      {
  ...
  var oe = ne(),
    se = ne({ defaultModifiers: [Dt, Zt, It, pt] }),
    re = ne({ defaultModifiers: [Dt, Zt, It, pt, Gt, Vt, Jt, xt, Kt] }),
    ae = Object.freeze({
      __proto__: null,
      popperGenerator: ne,
      detectOverflow: Yt,
      ...
      return (
        ...
        (s.show = function () {
          if (
            ...
            if (
              !j.trigger(this._element, "show.bs.dropdown", e).defaultPrevented
            ) {
              if (!this._inNavbar) {
                if (void 0 === ae)
                  throw new TypeError(
        ...
        (s.hide = function () {
          if (
            ...
            var t = o.getParentFromElement(this._element),
              e = { relatedTarget: this._element };
            j.trigger(t, "hide.bs.dropdown", e).defaultPrevented ||
                ...
                if (
                  ...
                  !(
                    (t &&
                      ...
                      c.contains(t.target)) ||
                    j.trigger(s, "hide.bs.dropdown", a).defaultPrevented
                  )
                )
                  "ontouchstart" in document.documentElement &&
                    (l = []).concat
                    ...
                    j.trigger(s, "hidden.bs.dropdown", a);
              }
            }
        }),
  ...
  j.on(
    ...
    j.on(document, "click.bs.dropdown.data-api", ye.clearMenus),
    j.on(document, "keyup.bs.dropdown.data-api", ye.clearMenus),
    j.on(
      document,
        ...
        (s._showElement = function (t) {
          ...
          var o = function () {
            e._config.focus && e._element.focus(),
              ...
              j.trigger(e._element, "shown.bs.modal", { relatedTarget: t });
          };
          if (i) {
            var s = d(this._dialog);
            j.one(this._dialog, "transitionend", o), p(this._dialog, s);
          } else o();
        }),
        ...
        (s._showBackdrop = function (t) {
          ...
          if (this._isShown && this._config.backdrop) {
            ...
            if (this._element.classList.contains("fade")) {
              ...
              j.one(this._backdrop, "transitionend", o), p(this._backdrop, s);
            } else o();
          } else t();
        }),
      ...
      return (
        ...
        (s._getConfig = function (t) {
          ...
          return (
            ...
            f(Ee, t, this.constructor.DefaultType),
            t.sanitize &&
  ...
  _(function () {
    ...
    if (t) {
      var e = t.fn[Ee];
      (t.fn[Ee] = Me.jQueryInterface),
        (t.fn[Ee].Constructor = Me),
  ...
  var Pe = "popover",
    ...
    je = i({}, Me.DefaultType, { content: "(string|element|function)" }),
    Ne = {
  ...
  _(function () {
    ...
    if (t) {
      var e = t.fn[Pe];
      (t.fn[Pe] = We.jQueryInterface),
        (t.fn[Pe].Constructor = We),
    ...
    Fe = (function (t) {
      ...
      return (
        ...
        (s._getConfig = function (t) {
          if (
            "string" !=
              typeof (t = i({}, Re, "object" == typeof t && t ? t : {}))
                .target &&
            h(t.target)
          ) {
            var e = t.target.id;
            e || ((e = r(He)), (t.target.id = e)), (t.target = "#" + e);
          }
          return f(He, t, Be), t;
        }),
  ...
  j.on(window, "load.bs.scrollspy.data-api", function () {
    ...
    _(function () {
      ...
      if (t) {
        var e = t.fn[He];
        (t.fn[He] = Fe.jQueryInterface),
          (t.fn[He].Constructor = Fe),
          (t.fn[He].noConflict = function () {
            return (t.fn[He] = e), Fe.jQueryInterface;
          });
      }
    });
  var qe = (function (t) {
    ...
    return (
      (o.show = function () {
        ...
        if (
          ...
          if (
            (e &&
              (s = j.trigger(e, "hide.bs.tab", {
                relatedTarget: this._element,
              })),
            !(
              j.trigger(this._element, "show.bs.tab", { relatedTarget: e })
                .defaultPrevented ||
            ...
            var r = function () {
              j.trigger(e, "hidden.bs.tab", { relatedTarget: t._element }),
                j.trigger(t._element, "shown.bs.tab", { relatedTarget: e });
            };
      ...
      (o._activate = function (t, e, i) {
        ...
        if (o && s) {
          var a = d(o);
          o.classList.remove("show"), j.one(o, "transitionend", r), p(o, a);
        } else r();
      }),
      ...
      (i.jQueryInterface = function (t) {
        return this.each(function () {
          var e = C(this, "bs.tab") || new i(this);
          if ("string" == typeof t) {
            if (void 0 === e[t])
              throw new TypeError('No method named "' + t + '"');
            e[t]();
  ...
  j.on(
    ...
    function (t) {
      t.preventDefault(), (C(this, "bs.tab") || new qe(this)).show();
    }
  ),
    _(function () {
      var t = y();
    ...
    t(document).on("mouseup", function () {
      ...
      t.widget("ui.slider", t.ui.mouse, {
        ...
        values: function (e, i) {
          ...
          for (n = this.options.values, o = e, s = 0; s < n.length; s += 1)
          ...
          this._hasMultipleValues()
            ...
            : ((n = this.value()),
              ...
              "max" === r &&
                ...
                this.range
                  .stop(1, 1)
                  [c ? "animate" : "css"]({ width: 100 - i + "%" }, a.animate),
              "min" === r &&
  ...
  (function (t) {
    ...
    var S,
      ...
      O = "inline",
      L = function () {
        x && (E.after(x.addClass(S)).detach(), (x = null));
      };
        ...
        getInline: function (i, n) {
          if ((L(), i.src)) {
            ...
            if (s.length) {
              ...
              r &&
                r.tagName &&
                (E || ((S = o.hiddenClass), (E = w(S)), (S = "mfp-" + S)),
                (x = s.after(E).detach().removeClass(S))),
        ...
        initRetina: function () {
          if (window.devicePixelRatio > 1) {
            var t = e.st.retina,
              i = t.ratio;
            (i = isNaN(i) ? i() : i) > 1 &&
              (b("ImageHasSize." + R, function (t, e) {
                e.img.css({
                  "max-width": e.img[0].naturalWidth / i,
                  width: "100%",
                });
              }),
              b("ElementParse." + R, function (e, n) {
    ...
    ***************************************************************************** */ function t(
      ...
      for (const [t, o] of Object.entries(e))
        if ("children" === t)
          ...
          "style" === t
            ...
            : "textContent" === t
            ? (i.textContent = o)
            : i.setAttribute(t, o.toString());
      return i;
    }
    function o(t, e, i) {
      const o = n(t, e || {});
      return null == i || i.appendChild(o), o;
    }
    var s = Object.freeze({ __proto__: null, createElement: o, default: o });
    const r = {
      fetchBlob: function (e, i, n) {
        return t(this, void 0, void 0, function* () {
          const o = yield fetch(e, n);
          if (o.status >= 400)
            throw new Error(
              `Failed to fetch ${e}: ${o.status} (${o.statusText})`
            );
          return (
            (function (e, i) {
              t(this, void 0, void 0, function* () {
                ...
                const n = e.body.getReader(),
                  o = Number(e.headers.get("Content-Length")) || 0;
                let s = 0;
                const r = (e) =>
                    t(this, void 0, void 0, function* () {
                      s += (null == e ? void 0 : e.length) || 0;
                      const t = Math.round((s / o) * 100);
                      i(t);
                    }),
                  a = () =>
                    t(this, void 0, void 0, function* () {
    ...
    class l extends e {
      constructor(t, e) {
        ...
        this.parent = i;
        const [n, o] = this.initHtml();
        i.appendChild(n),
          (this.container = n),
          (this.scrollContainer = o.querySelector(".scroll")),
          (this.wrapper = o.querySelector(".wrapper")),
          (this.canvasWrapper = o.querySelector(".canvases")),
          (this.progressWrapper = o.querySelector(".progress")),
          (this.cursor = o.querySelector(".cursor")),
          e && o.appendChild(e),
          this.initEvents();
      }
      ...
      initDrag() {
        this.subscriptions.push(
          (function (t, e, i, n, o = 3, s = 0, r = 100) {
            if (!t) return () => {};
            const a = matchMedia("(pointer: coarse)").matches;
            let l = () => {};
            const c = (c) => {
              if (c.button !== s) return;
              ...
              const p = Date.now(),
                f = (n) => {
                  ...
                  const s = n.clientX,
                    ...
                    c = s - d,
                    f = l - u;
                  if (h || Math.abs(c) > o || Math.abs(f) > o) {
                    const n = t.getBoundingClientRect(),
                      { left: o, top: r } = n;
                    h || (null == i || i(d - o, u - r), (h = !0)),
                      e(c, f, s - o, l - r),
                      (d = s),
                      (u = l);
                  }
            ...
            return (
              ...
              () => {
                l(), t.removeEventListener("pointerdown", c);
              }
            );
          })(
            this.wrapper,
      ...
      convertColorValues(t) {
        ...
        const e = document.createElement("canvas"),
          ...
          o = i.createLinearGradient(0, 0, 0, n),
          s = 1 / (t.length - 1);
        return (
          t.forEach((t, e) => {
            const i = e * s;
      ...
      renderBarWaveform(t, e, i, n) {
        const o = t[0],
          ...
          h = e.barGap ? e.barGap * d : e.barWidth ? u / 2 : 0,
          p = e.barRadius || 0,
          f = a / (u + h) / r,
        ...
        let g = 0,
          ...
          y = 0;
        for (let t = 0; t <= r; t++) {
          const r = Math.round(t * f);
          if (r > g) {
            const t = Math.round(v * c * n),
              o = t + Math.round(y * c * n) || 1;
            let s = c - t;
            "top" === e.barAlign
              ? (s = 0)
              : "bottom" === e.barAlign && (s = l - o),
              i[m](g * (u + h), s, u, o, p),
              (g = r),
              (v = 0),
              (y = 0);
          }
          const a = Math.abs(o[t] || 0),
            d = Math.abs(s[t] || 0);
          a > v && (v = a), d > y && (y = d);
        }
        i.fill(), i.closePath();
      ...
      renderLineWaveform(t, e, i, n) {
        const o = (e) => {
          ...
          let c = 0,
            d = 0;
          for (let t = 0; t <= s; t++) {
            const s = Math.round(t * l);
            if (s > c) {
              const t = a + (Math.round(d * a * n) || 1) * (0 === e ? -1 : 1);
              i.lineTo(c, t), (c = s), (d = 0);
            }
            const r = Math.abs(o[t] || 0);
            r > d && (d = r);
          }
          i.lineTo(c, a);
        };
      ...
      renderSingleCanvas(t, e, i, n, o, s, r, a) {
        const l = window.devicePixelRatio || 1,
          c = document.createElement("canvas"),
          d = t[0].length;
        (c.width = Math.round((i * (s - o)) / d)),
          (c.height = n * l),
          (c.style.width = `${Math.floor(c.width / l)}px`),
          (c.style.height = `${n}px`),
          (c.style.left = `${Math.floor((o * i) / l / d)}px`),
          r.appendChild(c);
      ...
      renderChannel(e, i, n, o) {
        ...
        return t(this, void 0, void 0, function* () {
          const i = document.createElement("div"),
            a = this.getHeight(r.height);
          (i.style.height = `${a}px`),
            s && o > 0 && (i.style.marginTop = `-${a}px`),
            (this.canvasWrapper.style.minHeight = `${a}px`),
            this.canvasWrapper.appendChild(i);
          const c = i.cloneNode();
          ...
          if (!this.isScrollable && n < l.MAX_CANVAS_WIDTH) return void u(0, d);
          const {
              scrollLeft: h,
              scrollWidth: p,
              clientWidth: f,
            ...
            m = d / p;
          let g = Math.min(l.MAX_CANVAS_WIDTH, f);
          if (r.barWidth || r.barGap) {
            const t = r.barWidth || 0.5,
              e = t + (r.barGap || t / 2);
            g % e != 0 && (g = Math.floor(g / e) * e);
          }
          const v = Math.floor(Math.abs(h) * m),
            y = Math.floor(v + g * m),
            _ = y - v;
          _ <= 0 ||
            (u(v, y),
      ...
      render(e) {
        return t(this, void 0, void 0, function* () {
          ...
          const o = this.options.fillParent && !this.isScrollable,
            s = (o ? i : n) * t;
          (this.wrapper.style.width = o ? "100%" : `${n}px`),
          ...
          try {
            if (this.options.splitChannels)
              yield Promise.all(
                Array.from({ length: e.numberOfChannels }).map((t, i) => {
                  var n;
                  ...
                  return this.renderChannel([e.getChannelData(i)], o, s, i);
                })
              );
            else {
      ...
      scrollIntoView(t, e = !1) {
        ...
        if (this.isDragging) {
          ...
          s + t > a
            ? (this.scrollContainer.scrollLeft += t)
            : s - t < r && (this.scrollContainer.scrollLeft -= t);
        } else {
          (s < r || s > a) &&
            (this.scrollContainer.scrollLeft =
              s - (this.options.autoCenter ? l : 0));
          const t = s - i - l;
          e &&
            ...
            Array.from(t).map(
              (t) =>
                new Promise((n, o) => {
                  t.toBlob(
                    (t) => {
                      t ? n(t) : o(new Error("Could not export image"));
                    },
                    e,
                    i
                  );
    ...
    class h extends a {
      ...
      constructor(t) {
        ...
        (this.renderer = new l(this.options, i)),
        ...
        return t(this, void 0, void 0, function* () {
          if (
            ...
            window.AbortController &&
              ...
              (t.signal =
                null === (a = this.abortController) || void 0 === a
                  ? void 0
                  : a.signal));
            const i = (t) => this.emit("loading", t);
            n = yield r.fetchBlob(e, i, t);
          }
          this.setSrc(e, n);
          const t =
            s ||
          ...
          if (o) this.decodedData = i.createBuffer(o, t || 0);
          else if (n) {
      ...
      loadBlob(e, i, n) {
        return t(this, void 0, void 0, function* () {
          try {
            return yield this.loadAudio("blob", e, i, n);
          } catch (t) {
            throw (this.emit("error", t), t);
          }
        });
      ...
      exportPeaks({
        ...
        for (let t = 0; t < n; t++) {
          const n = this.decodedData.getChannelData(t),
            ...
            r = n.length / e;
          for (let t = 0; t < e; t++) {
            const e = n.slice(Math.floor(t * r), Math.ceil((t + 1) * r));
            let o = 0;
            for (let t = 0; t < e.length; t++) {
              const i = e[t];
              Math.abs(i) > Math.abs(o) && (o = i);
            }
            s.push(Math.round(o * i) / i);
          }
          o.push(s);
        }
        return o;
